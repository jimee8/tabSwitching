...
if (btnA) {
    btnA.addEventListener("click", function() {
        window.location.href = "http://localhost:8080/redirect?page=A";
    });
}
...
if (btnB) {
    btnB.addEventListener("click", function() {
        window.location.href = "http://localhost:8080/redirect?page=B";
    });
}
...
// This is for page B, it is a button that shows a random number
